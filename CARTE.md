...
On explore la forme d'un **outil de démocratie** — un lieu multi-échelle et multi-points-de-vue pour penser et agir ensemble. Rien n'est figé.
...
- Quelle **forme concrète** pour l'outil ? (duel à 2 ? carte à N points de vue ?)
