...
- **Slogan / expression associée (à une idée)** — Formule courte accrochée à une graine : slogan candidat, expression courante, proverbe, ou phrase qui circule déjà (même un peu stupide ou toxique). Ce n'est pas encore un slogan *distillé* du collectif. Voir [`../idees/README.md`](../idees/README.md) et [`../decisions/0002-slogans-brique-et-accroche-des-idees.md`](../decisions/0002-slogans-brique-et-accroche-des-idees.md).
...
- **Slogan** — Mot à trois usages dans ce dépôt : (1) *accroche d'idée* ; (2) *slogan distillé* d'un consensus dans [`../slogans/`](../slogans/), avec raisonnement traçable ; (3) *slogan-objet* d'enquête (piste atlas). Un slogan distillé sans raisonnement n'est pas admis. Les slogans sont une **brique majeure** de la machine à penser, pas sa définition fermée (voir [`../idees/2026-07-24-slogans-porte-pas-maison.md`](../idees/2026-07-24-slogans-porte-pas-maison.md)).
...
- **Ego social (mise en scène de l')** — Dynamique de profils, followers, likes publics et clash qui sélectionne la polarisation. Piste opposée : responsabilité traçable sans personal branding (voir [`../idees/2026-07-24-gouvernance-sans-ego-social.md`](../idees/2026-07-24-gouvernance-sans-ego-social.md)).
- **Plaisir sain (et compétitif)** — Remplacer les mécaniques primitives (outrage, FOMO, domination) par d'autres plaisirs désirables : appartenir, jouer, progresser, coopérer, humour — sans moraliser l'abstinence. Voir [`../idees/2026-07-24-plaisir-sain-competitif.md`](../idees/2026-07-24-plaisir-sain-competitif.md).
- **Sport coopératif (du débat)** — Mécanique où « gagner » = comprendre l'autre (reformulation obligatoire, votes sur la compréhension / le progrès), plutôt qu'humilier. Voir [`../idees/2026-07-24-debat-sport-cooperatif.md`](../idees/2026-07-24-debat-sport-cooperatif.md).
- **Petit internet** — Pari que la qualité relationnelle revient à petite échelle (micro-communautés interconnectées, réputation réelle, réseau de confiance) plutôt que via un feed global unique. Voir [`../idees/2026-07-24-petit-internet-micro-communautes.md`](../idees/2026-07-24-petit-internet-micro-communautes.md).
- **Miroir des bulles** — Porte d'entrée produit type « Spotify Wrapped de ton cerveau numérique » : rendre visible l'univers mental / algorithmique de chacun par curiosité et partage, sans sermon. Voir [`../idees/2026-07-24-miroir-des-bulles.md`](../idees/2026-07-24-miroir-des-bulles.md).
