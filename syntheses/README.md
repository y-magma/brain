...
Les **cartes**. À partir d'un ou plusieurs débats, on distingue clairement ce qui rassemble, ce qui sépare, et ce qui manque.

## Produire une synthèse

1. Copier [`_gabarit-synthese.md`](_gabarit-synthese.md).
2. Renommer en `AAAA-MM-JJ-sujet.md`.
3. Remplir, ouvrir une Pull Request.

## Trois catégories, toujours

- **Convergences** — les accords réels.
